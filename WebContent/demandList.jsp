	         ...
	         <c items="${userID }" var="userID"></c>
				...
				<div class="page-header">
					...
					<table class="table table-bordered table-hover">
							...
							<tbody>
							  <c:forEach items="${demandlist}" var="rs">
							     <tr>
							         <td>${rs.demandID}</td>
							         <td>${rs.demandName}</td>
							         <td>${rs.demandNum}</td>
							         ...
							         <td>${rs.LPrice}</td>
							         <td>${rs.HPrice}</td>
							         <td><a href="http://localhost:8080/MultiAgentSystem/information/listonedemand?demandID=${rs.demandID}&userID=${userID }">查看</a></td>
