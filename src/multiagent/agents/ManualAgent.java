...
/**
 * ManualAgent类用于对汽车制造供应链上制造商行为的的模拟。
 * 通过继承Agent父类，拥有Agent的通用功能行为。为该Agent添加三个行为，
 * 分别为OneShotBehaviour、OneShotBehaviour以及SimpleBehaviour。
